/* Affiliate Miner Content Script v1.4.4 — Enhanced Shopee/TikTok Card & PDP Extraction */
      ...
      <div class="am-header" id="am-drag-handle">
        <div class="am-header-left">
          ...
          <div>
            ...
            <div class="am-header-ver">v${(typeof chrome !== 'undefined' && chrome.runtime && chrome.runtime.getManifest) ? chrome.runtime.getManifest().version : '1.4.4'}</div>
          </div>
        </div>
        <div class="am-header-actions">
